...
import 'package:chatgpt_client/http/config.dart';
import 'package:chatgpt_client/http/exception.dart';
import 'package:chatgpt_client/model/api_response/api_response_entity.dart';
import 'package:chatgpt_client/model/api_response/raw_data.dart';
...
class RequestClient {
  ...
  RequestClient({String? baseUrl}) {
    _dio = Dio(
        BaseOptions(baseUrl: baseUrl ?? RequestConfig.baseUrl, connectTimeout: RequestConfig.connectTimeout));
    _dio.interceptors.add(PrettyDioLogger(
        requestHeader: true, requestBody: true, responseHeader: true));
    _dio.interceptors.add(CookieManager(APIS.cookieJar));
  }
